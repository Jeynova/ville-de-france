...
--
-- Table structure for table `node__field_ville`
--

DROP TABLE IF EXISTS `node__field_ville`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `node__field_ville` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for node field field_ville.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `node__field_ville`
--
