...
--
-- Table structure for table `node__field_geolocation_demo_taxonomy`
--

DROP TABLE IF EXISTS `node__field_geolocation_demo_taxonomy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `node__field_geolocation_demo_taxonomy` (
