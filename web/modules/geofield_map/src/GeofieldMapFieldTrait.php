...
trait GeofieldMapFieldTrait {
  ...
  private function setMapMarkerAndInfowindowElement(array $form, array $settings, array &$elements) {
    ...
    $icon_image_path_description = $this->t('Input the Specific Icon Image path (absolute path, or relative to the Drupal site root, without prefixing with a trailing hash).');
